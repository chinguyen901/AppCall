...
public class CallManager
{
	...
	public Set<PortSipEnumDefine.AudioDevice> getSelectableAudioDevice(){
		HashSet<PortSipEnumDefine.AudioDevice> audioDevices = new HashSet<PortSipEnumDefine.AudioDevice>();
	...
	public Session findCallByUUID(@NonNull String sessionUUID)
	{
		for(Session session :sessions)
		{
			if (sessionUUID.equals(session.sessionUUID))
			{
				return session;
			}
		}
