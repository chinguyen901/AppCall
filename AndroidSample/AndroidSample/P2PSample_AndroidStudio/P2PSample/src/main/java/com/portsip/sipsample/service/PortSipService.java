...
public class PortSipService extends Service implements OnPortSIPEvent, NetworkManager.NetWorkChangeListner{
    public static final String ACTION_SIP_REGIEST = "PortSip.p2pSample.Test.REGIEST";
    public static final String ACTION_SIP_UNREGIEST = "PortSip.p2pSample.Test.UNREGIEST";
    ...
    public static final String ACTION_SIP_AUDIODEVICE = "PortSip.p2pSample.Test.AudioDeviceUpdate";
    public static final String REGISTER_CHANGE_ACTION = "PortSip.p2pSample.Test.RegisterStatusChagnge";
    public static final String CALL_CHANGE_ACTION = "PortSip.p2pSample.Test.CallStatusChagnge";
    public static final String PRESENCE_CHANGE_ACTION = "PortSip.p2pSample.Test.PRESENCEStatusChagnge";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            if (ACTION_SIP_REGIEST.equals(intent.getAction()) && !CallManager.Instance().isRegistered) {
                registerToServer();
    ...
    public void registerToServer() {
        ...
        if (result == PortSipErrorcode.ECoreErrorNone) {
            ...
            if (result != PortSipErrorcode.ECoreWrongLicenseKey) {
                ...
                ConfigPreferences(this, prefences, mEngine);

                mEngine.enable3GppTags(false);

                String name = "P2P";//useless,Only for display .any characters will be ok
                String pwd = "P2P";//useless,any characters will be ok
                result = mEngine.setUser(name, "", null, pwd,
