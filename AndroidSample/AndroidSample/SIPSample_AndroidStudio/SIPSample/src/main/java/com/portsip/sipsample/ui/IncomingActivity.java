...
import static com.portsip.sipsample.service.PortSipService.EXTRA_CALL_SESSION_ID;
...
public class IncomingActivity extends Activity implements PortMessageReceiver.BroadcastListener, View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        sessionId = intent.getLongExtra(EXTRA_CALL_SESSION_ID, PortSipErrorcode.INVALID_SESSION_ID);
    ...
    public void onBroadcastReceiver(Intent intent) {
        ...
        {
            long sessionId = intent.getLongExtra(EXTRA_CALL_SESSION_ID, Session.INVALID_SESSION_ID);
